...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/wallet/china-transfer/quote', [BuyerChinaTransferController::class, 'quote'])->name('wallet.china-transfer.quote');
    Route::get('/wallet/china-transfer/{chinaTransfer}', [BuyerChinaTransferController::class, 'show'])->name('wallet.china-transfer.show');
    Route::post('/wallet/china-transfer/{chinaTransfer}/cancel', [BuyerChinaTransferController::class, 'cancel'])->name('wallet.china-transfer.cancel');
    Route::get('/wallet/sell-rmb', [BuyerSellRmbController::class, 'index'])->name('wallet.sell-rmb.index');
    Route::get('/wallet/sell-rmb/create', [BuyerSellRmbController::class, 'create'])->name('wallet.sell-rmb.create');
...
Route::prefix('seller')->name('seller.')->middleware(['auth', 'role:seller'])->group(function () {
    ...
    Route::middleware(['seller.approved'])->group(function () {
        ...
        Route::middleware(['seller.store-setup'])->group(function () {
            ...
            Route::match(['patch', 'post'], '/orders/{orderItem}', [SellerOrderController::class, 'update'])->name('orders.update');
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::post('/china-transfers/{chinaTransfer}/reject', [AdminChinaTransferController::class, 'reject'])->name('china-transfers.reject');
    ...
    Route::post('/china-transfer/methods/{method}/deactivate', [AdminChinaTransferSettingsController::class, 'destroyMethod'])->name('china-transfer.methods.destroy');
    ...
    Route::post('/sell-rmb/{sellRmbTransfer}/note', [AdminSellRmbController::class, 'note'])->name('sell-rmb.note');
    Route::get('/sell-rmb-settings', [AdminSellRmbSettingsController::class, 'edit'])->name('sell-rmb.settings');
    Route::post('/sell-rmb-settings', [AdminSellRmbSettingsController::class, 'updateSettings'])->name('sell-rmb.settings.update');
    ...
    Route::post('/sell-rmb/fields/{field}/deactivate', [AdminSellRmbSettingsController::class, 'destroyField'])->name('sell-rmb.fields.destroy');
