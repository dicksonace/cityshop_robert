...
class OrderService
{
    ...
    public function updateOrderItemStatus(OrderItem $item, array $data): OrderItem
    {
        ...
        if ($status === 'awaiting_confirmation' && $previousStatus !== 'awaiting_confirmation') {
        ...
        if ($status === 'call_confirmed' && $previousStatus !== 'call_confirmed') {
        ...
        if ($status === 'delivered' && $previousStatus !== 'delivered' && $item->order->payment_method === 'cash') {
