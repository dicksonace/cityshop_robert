                ...
                <div className="mx-auto max-w-7xl px-4 py-10">
                    <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="flex items-center gap-5">
                            <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white/10 text-3xl font-bold text-white backdrop-blur-sm ring-2 ring-white/20">
                                {store.shop_photo ? (
                            ...
                            <div className="text-white">
                                <div className="flex items-center gap-2">
                                    <h1 className="text-2xl font-bold md:text-3xl">{storeName}</h1>
                        ...
                        <div className="flex flex-wrap gap-2">
                            <button
                                ...
                                className="inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2.5 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20"
                            >
                            ...
                            {auth.user && auth.user.id !== store.user_id && (
                                <MessageSellerButton sellerId={store.user_id} variant="banner" label="Message Seller" />
                            )}
                            <button
                                type="button"
