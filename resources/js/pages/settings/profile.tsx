                ...
                <div className="space-y-6">
                    <HeadingSmall
                        ...
                        description={
                            canEditDetails
                                ...
                                : 'Name, email, and phone can only be changed by CityShop admin'
                        }
                    />
                    ...
                    {canEditDetails ? (
                        ...
                        <div className="space-y-4">
                            <div className="grid gap-2">
                                <Label htmlFor="name">Name</Label>
                                <Input id="name" className="mt-1 block w-full bg-gray-50" value={auth.user.name} readOnly />
                            </div>
                            ...
                            <p className="text-sm text-gray-500">
                                To change your name, email, or phone number, contact CityShop support.
                            </p>
                        </div>
                    )}
                </div>
