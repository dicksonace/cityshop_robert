        ...
        <AdminLayout title="Message Sellers" active="announcements">
            ...
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                <p className="text-sm text-gray-600">
                    Send in-app alerts to one seller, selected sellers, or every approved seller.
                </p>
            ...
            {announcements.data.length === 0 ? (
                <div className="rounded-xl bg-white p-12 text-center shadow-sm">
                    ...
                    <p className="mt-3 text-gray-500">No seller messages sent yet.</p>
                    <Link href={route('admin.announcements.create')} className="mt-4 inline-block text-sm text-orange-500 hover:underline">
