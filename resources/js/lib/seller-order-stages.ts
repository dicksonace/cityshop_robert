...
export const sellerOrderStages: SellerOrderStage[] = [
    ...
    },
    {
        ...
        emptyHint: 'After you deliver, buyers confirm here. Admin then releases Pending funds.',
        cta: 'View now',
        icon: PackageCheck,
    ...
    },
    {
        ...
        description: 'Buyer confirmed delivery. CityShop admin releases Pending funds to Available.',
