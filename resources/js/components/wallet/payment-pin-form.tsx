...
export type PaymentPinFormProps = {
...
export default function PaymentPinForm({
    hasPaymentPin,
    hasEmail = true,
    hasMobile = false,
    status,
        ...
        <div className="space-y-6">
            ...
            {mode === 'manage' && !hasPaymentPin && (
                <form onSubmit={submitSet} className="space-y-4">
                    ...
                    <Button disabled={setForm.processing} className="bg-orange-500 hover:bg-orange-600">
                        Set payment PIN
                    </Button>
                </form>
            )}
                    ...
                    <form onSubmit={submitChange} className="space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    changeForm.setData('pin_confirmation', e.target.value.replace(/\D/g, '').slice(0, 4))
                                }
                                autoComplete="off"
                            />
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={changeForm.processing} className="bg-orange-500 hover:bg-orange-600">
                                Update PIN
                            </Button>
                            <Transition
            ...
            {mode === 'reset' && (
                <form onSubmit={submitReset} className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Button disabled={resetForm.processing} className="bg-orange-500 hover:bg-orange-600">
                            Reset PIN
                        </Button>
